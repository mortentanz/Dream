...
namespace Dream.Data.Demographics
{
  ...
  /// <summary>
  /// Provides information on how immigration is forecasted.
  /// </summary>
  public class ImmigrationInfo : ForecastInfo
  {

    #region Fields
    private Series input = null;
    private ImmigrationEstimationInfo estimation = null;
    ...
    /// <summary>
    /// Supported methods for scaling immigration rates.
    /// </summary>
    public enum ScaleOption
    {
      /// <summary>
      /// The immigration forecast does not use scaling in its specification (default).
      /// </summary>
      None,
      /// <summary>
      ...
      UseScaleFactor,
      /// <summary>
      /// Scale to target total immigration rate.
      /// </summary>
      UseTotalImmigrationRate
    }
    #endregion

    #region Constructors
    /// <summary>
    /// Default constructor for a reference immigration forecast.
    /// </summary>
    public ImmigrationInfo() : this(ForecastSpecification.Reference, FlowDetermination.Endogenous) { }

    /// <summary>
    /// Constructor for a specific immigration forecast specification.
    /// </summary>
    ...
    public ImmigrationInfo(ForecastSpecification specification, FlowDetermination determination)
      : base(ForecastType.Immigration)
    {
    ...
    /// Copy constructor.
    /// </summary>
    /// <param name="info">The ImmigrationInfo instance to copy.</param>
    public ImmigrationInfo(ImmigrationInfo info)
      : base(info)
    {
    ...
    #region Properties
    /// <summary>
    /// States the type of immigration forecast specification.
    /// </summary>
    ...
    /// <summary>
    /// The series of historic years to use as input for determining non-estimated immigration rates.
    /// </summary>
    public Series Input
    {
      get { return input; }
      set 
      {
        if (!input.Equals(value))
        {
          ...
          {
            throw new ArgumentException("The series of forecasted immigration should follow the InputSeries.");
          }
    ...
    /// <summary>
    /// An immigration estimation to be used as input for reference specifications. May be null.
    /// </summary>
    [XmlIgnore]
    public ImmigrationEstimationInfo Estimation
    {
    ...
    /// <summary>
    /// States whether the current state of the immigration forecast information has been written to the database.
    /// </summary>
    [XmlIgnore]
    ...
    /// <summary>
    /// If Specification is Constant this property states the first year in which immigration is held constant.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the method used for scaling immigration rates.
    /// </summary>
    ...
    /// <summary>
    /// Validates the state integrity of the current ImmigrationInfo object.
    /// </summary>
    /// <returns>True if the ImmigrationInfo is in a valid state, false otherwise.</returns>
    ...
    /// </summary>
    /// <returns>A new ImmigrationInfo object with the same descriptive properties as the current instance.</returns>
    public ImmigrationInfo Copy()
    {
      ImmigrationInfo info = new ImmigrationInfo(this);
      return info;
    }
    ...
    /// </summary>
    /// <returns>A new ImmigrationInfo object identical to the current instance.</returns>
    internal ImmigrationInfo Clone()
    {
      ImmigrationInfo info = new ImmigrationInfo(this);
